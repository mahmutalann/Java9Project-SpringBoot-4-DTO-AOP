...
public class UsersController {
	...
	@PostMapping(value = "/add")  //The user gives data. It means that given data is added.
	public ResponseEntity<?> add(@Valid @RequestBody User user) { //Data is read by this @RequestBody.
	...
	public ErrorDataResult<Object> handleValidationExcepiton(MethodArgumentNotValidException exceptions){
		...
		ErrorDataResult<Object> errors = new ErrorDataResult<Object>(validationErrors, "Validation Errors"); //It converts Validation Errors to ErrorDataResult.
		return errors;
	}
}
